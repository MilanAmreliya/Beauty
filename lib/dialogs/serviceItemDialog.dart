      ...
      return Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // topItemImagelist(),
            centerView(
                _isSelected, serviceName, serviceCategoryName, price, rating,
                onTap: () async {
              dialogSetState(() {
...
Padding centerView(bool isSelected, String serviceName,
    String serviceCategoryName, dynamic price, double rating,
    {Function onTap}) {
  return Padding(
    padding: EdgeInsets.symmetric(
